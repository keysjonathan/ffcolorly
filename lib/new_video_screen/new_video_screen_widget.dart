...
class NewVideoScreenWidget extends StatefulWidget {
...
class _NewVideoScreenWidgetState extends State<NewVideoScreenWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<PostsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PostsRecord> newVideoScreenPostsRecordList = snapshot.data;
        return Scaffold(
          key: scaffoldKey,

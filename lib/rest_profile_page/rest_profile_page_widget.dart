...
class RestProfilePageWidget extends StatefulWidget {
  ...
  @override
  _RestProfilePageWidgetState createState() => _RestProfilePageWidgetState();
}

class _RestProfilePageWidgetState extends State<RestProfilePageWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RestaurantsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RestaurantsRecord> restProfilePageRestaurantsRecordList =
            snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
